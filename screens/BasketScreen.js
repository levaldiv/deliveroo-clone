...
const BasketScreen = () => {
  ...
  // grouping items in basket by category
  useEffect(() => {
    // looping through items in basket
    const groupedItems = items.reduce((results, item) => {
      // creating a key whereby if the key exists, push item into that key
    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className='flex-1 bg-gray-100'>
        ...
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
            ...
            <Text className="flex-1">Have it delivered in 6 to 9 years</Text>
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
                ...
                <View className="flex-row justify-between">
                    ...
                    <Text className="text-gray-400"><Currency quantity={5.99} currency="USD" /></Text>
                </View>
                
                <View className="flex-row justify-between">
                    <Text>Order Total</Text>
                    <Text className="font-extrabold"><Currency quantity={basketTotal + 4.99} currency="USD" /></Text>
                </View>
